...
class _ScanHistoryScreenState extends State<ScanHistoryScreen> {
  ...
  Future<void> _loadLanguage(String userId) async {
    final profile = await Supabase.instance.client
        ...
        .maybeSingle();
    if (mounted) {
      _language = profile?['preferred_language'] as String? ?? 'en';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : _scans.isEmpty
              ? Center(child: Text(t.noScansYet))
              : RefreshIndicator(
                  onRefresh: _load,
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final color = verdict == 'GREEN'
                          ...
                          : verdict == 'RED'
                              ? AppColors.red
                              : AppColors.amber;
                      final label = t.verdictLabel(verdict);
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                Text(s['product_name'] as String? ?? t.unknown,
